      ...
      <div className="bg-white w-[1100px] mx-auto rounded-xl min-h-[700px] shadow-md border-black/20 overflow-hidden grid grid-cols-[16rem_1fr]">
        ...
        <main className='p-4'>
          <div className="max-w-[700px] mx-auto pt-16 ">
            <h1>meu notion</h1>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sint neque molestias ut suscipit hic similique veniam sequi velit optio, deserunt aliquam numquam nobis cupiditate quos cumque corporis voluptatibus! Excepturi, quis.</p>
          </div>
        </main>
      </div>
    </div>
